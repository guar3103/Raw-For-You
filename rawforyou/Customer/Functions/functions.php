...
if(mysqli_connect_errno()){
	...
	echo "The content was not established:" .mysqli_connect_errno();
}
...
function getCatPro(){
	...
	$count_cats = mysqli_num_rows($run_cat_pro);
		...
		if($count_cats==0){
			echo "<h2 style= 'padding:10px;'>Sorry , There is no product right now !<h2>";
...
function getBrandPro(){
	...
	$count_brands = mysqli_num_rows($run_brand_pro);
		...
		if($count_brands==0){
			echo "<h2 style= 'padding:10px;'>Sorry , There is no product associated with this now !<h2>";
